...
public class AiImageController {
    ...
    // ================ GeekAI 专属 ================
    @Operation(summary = "【GeekAI】生成图片")
    @PostMapping("/geekai/gemini/imagine")
    public CommonResult<Long> geekAiImagine(@Valid @RequestBody AiGeekAiImagineReqVO reqVO) {
        Long imageId = imageService.geekAiGeminiImagine(getLoginUserId(), reqVO);
        return success(imageId);
    }
